...
import { BAO_BI_ARTICLE_THUMBNAILS, baoBiThumbnailPath } from "./seo-article-helpers.mjs";
...
for (const [slug, entry] of Object.entries(BAO_BI_ARTICLE_THUMBNAILS)) {
  const imagePath = baoBiThumbnailPath(slug);
...
console.log("Done — bao-bi thumbnails.");
