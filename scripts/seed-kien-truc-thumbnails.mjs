...
import { KIEN_TRUC_ARTICLE_THUMBNAILS, kienTrucThumbnailPath } from "./seo-article-helpers.mjs";
...
for (const [slug, entry] of Object.entries(KIEN_TRUC_ARTICLE_THUMBNAILS)) {
  const imagePath = kienTrucThumbnailPath(slug);
...
console.log("Done — kien-truc thumbnails.");
