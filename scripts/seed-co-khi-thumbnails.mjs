...
import { CO_KHI_ARTICLE_THUMBNAILS, coKhiThumbnailPath } from "./seo-article-helpers.mjs";
...
for (const [slug, entry] of Object.entries(CO_KHI_ARTICLE_THUMBNAILS)) {
  const imagePath = coKhiThumbnailPath(slug);
...
console.log("Done — co-khi thumbnails.");
