...
import { NHA_KHOA_ARTICLE_THUMBNAILS, nhaKhoaThumbnailPath } from "./seo-article-helpers.mjs";
...
for (const [slug, entry] of Object.entries(NHA_KHOA_ARTICLE_THUMBNAILS)) {
  const imagePath = nhaKhoaThumbnailPath(slug);
...
console.log("Done — nha-khoa thumbnails.");
