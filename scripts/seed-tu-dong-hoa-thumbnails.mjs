...
import { TU_DONG_HOA_ARTICLE_THUMBNAILS, tuDongHoaThumbnailPath } from "./seo-article-helpers.mjs";
...
for (const [slug, entry] of Object.entries(TU_DONG_HOA_ARTICLE_THUMBNAILS)) {
...
console.log("Done — tu-dong-hoa thumbnails.");
