...
const REWRITES = [REWRITE_THIET_KE_WEBSITE_PHONG_KHAM_DA_KHOA];
...
async function upsertArticle(article) {
  ...
  const count = (article.content.match(/\/tin-tuc\/phong-kham\//g) || []).length;
  console.log(
    `Updated: ${article.slug} (${count} phong-kham images in content)`,
...
console.log("Done — phong-kham content seeded.");
