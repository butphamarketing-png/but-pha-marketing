...
const STEPS = [
  ...
  { label: "Phase 3 money KW tracker + seed gate", cmd: "npm", args: ["run", "build:phase3-money-kw-pack"] },
  { label: "Phase 3 local URL export", cmd: "npm", args: ["run", "export:phase3-local-urls"] },
  { label: "GSC post-deploy checklist", cmd: "npm", args: ["run", "build:gsc-post-deploy"] },
