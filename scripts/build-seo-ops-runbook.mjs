...
lines.push("");
lines.push("## Tuần này (manual)");
lines.push("1. **GSC indexing** — `tmp-programmatic/gsc-indexing-checklist.md` (30 URL)");
lines.push("2. **Backlink** — copy `vertical-syndication-snippets.md` + log `npm run build:backlink-weekly-tracker -- --log=\"...\"`");
lines.push("3. **Mockup HD** — drop WebP 1920px vào `public/tin-tuc/{ngành}/hd/` → `npm run audit:industry-mockup-dimensions`");
lines.push("");
