...
lines.push("4. **Directory VN** — `tmp-programmatic/directory-citation-pack-vn.md` (6 citation tuần 1)");
lines.push("5. **Backlink log** — `npm run build:backlink-weekly-tracker -- --log=\"...\"`");
lines.push("");
