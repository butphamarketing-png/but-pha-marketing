...
import { LUAT_ARTICLE_THUMBNAILS, luatThumbnailPath } from "./seo-article-helpers.mjs";
...
for (const [slug, entry] of Object.entries(LUAT_ARTICLE_THUMBNAILS)) {
  const imagePath = luatThumbnailPath(slug);
...
console.log("Done — luat thumbnails.");
