...
import { PHONG_KHAM_ARTICLE_THUMBNAILS, phongKhamThumbnailPath } from "./seo-article-helpers.mjs";
...
for (const [slug, entry] of Object.entries(PHONG_KHAM_ARTICLE_THUMBNAILS)) {
  const imagePath = phongKhamThumbnailPath(slug);
...
console.log("Done — phong-kham thumbnails.");
