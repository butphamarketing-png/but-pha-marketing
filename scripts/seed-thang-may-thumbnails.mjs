...
import { THANG_MAY_ARTICLE_THUMBNAILS, thangMayThumbnailPath } from "./seo-article-helpers.mjs";
...
for (const [slug, entry] of Object.entries(THANG_MAY_ARTICLE_THUMBNAILS)) {
  const imagePath = thangMayThumbnailPath(slug);
...
console.log("Done — thang-may thumbnails.");
