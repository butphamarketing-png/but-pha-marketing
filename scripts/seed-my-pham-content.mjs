...
const REWRITES = [REWRITE_THIET_KE_WEBSITE_MY_PHAM_LAM_DEP, REWRITE_THIET_KE_WEBSITE_MY_PHAM];
...
async function upsertArticle(article) {
  ...
  const count = (article.content.match(/\/tin-tuc\/my-pham\//g) || []).length;
  console.log(
    `Updated: ${article.slug} (${count} my-pham images in content)`,
...
console.log("Done — my-pham content seeded.");
