...
import { MY_PHAM_ARTICLE_THUMBNAILS, myPhamThumbnailPath } from "./seo-article-helpers.mjs";
...
for (const [slug, entry] of Object.entries(MY_PHAM_ARTICLE_THUMBNAILS)) {
  const imagePath = myPhamThumbnailPath(slug);
...
console.log("Done — my-pham thumbnails.");
