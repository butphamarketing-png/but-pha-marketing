...
export const CUSTOMER_KEYWORDS_100 = [
  ...
  { slug: "thiet-ke-fanpage-facebook", keywordsMain: "thiết kế fanpage", h1: "Thiết Kế Fanpage Facebook Chuyên Nghiệp — Cover & Layout 2026", angle: "cover, avatar và layout fanpage chuẩn thương hiệu", niche: "social" },
  ...
  { slug: "cham-soc-fanpage", keywordsMain: "chăm sóc fanpage", h1: "Chăm Sóc Fanpage — Gói Content & Quản Trị Hàng Tháng", angle: "đăng bài, trả lời inbox và báo cáo fanpage", niche: "social" },
  ...
  { slug: "quang-cao-facebook", keywordsMain: "quảng cáo Facebook", h1: "Quảng Cáo Facebook — Hướng Dẫn Chạy Ads Hiệu Quả 2026", angle: "setup chiến dịch Facebook Ads từ A-Z", niche: "facebook-ads" },
  ...
  { slug: "tu-van-marketing-mien-phi", keywordsMain: "tư vấn marketing", h1: "Tư Vấn Marketing Miễn Phí — Đặt Lịch Với Bứt Phá", angle: "buổi tư vấn marketing ban đầu không mất phí", niche: "strategy" },
