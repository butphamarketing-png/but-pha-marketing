...
import { BAT_DONG_SAN_ARTICLE_THUMBNAILS, batDongSanThumbnailPath } from "./bat-dong-san-images.mjs";
...
for (const [slug, entry] of Object.entries(BAT_DONG_SAN_ARTICLE_THUMBNAILS)) {
  const imagePath = batDongSanThumbnailPath(slug);
...
console.log("Done — bat-dong-san thumbnails.");
