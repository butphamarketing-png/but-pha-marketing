...
const REWRITES = [REWRITE_THIET_KE_WEBSITE_LOGISTICS_VAN_TAI];
...
async function upsertArticle(article) {
  ...
  const count = (article.content.match(/\/tin-tuc\/logistics\//g) || []).length;
  console.log(
    `Updated: ${article.slug} (${count} logistics images in content)`,
...
console.log("Done — logistics content seeded.");
