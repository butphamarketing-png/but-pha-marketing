import { wrapArticle, img, toc, internalLinks, externalLinks } from "./seo-article-helpers.mjs";
...
export const SEO_ARTICLES = [
  {
    ...
    imageUrl: "https://www.butphamarketing.com/Website.png",
    content: wrapArticle({
      metaTitle: "Thiết Kế Website Doanh Nghiệp Chuyên Nghiệp Chuẩn SEO",
      html: `
${toc([
...
${img(0, "thiết kế website doanh nghiệp chuyên nghiệp")}
...
${img(1, "giao diện website doanh nghiệp hiện đại")}
...
${img(2, "quy trình thiết kế website doanh nghiệp")}
...
`,
  ...
  },
  {
    ...
    imageUrl: "https://www.butphamarketing.com/slideshow-hero.png",
    content: wrapArticle({
      metaTitle: "Thiết Kế Website Chuẩn SEO Tối Ưu Hiển Thị Google",
      html: `
${toc([
...
${img(1, "thiết kế website chuẩn seo tối ưu google")}
...
${img(0, "cấu trúc seo on-page cho website")}
...
${img(3, "nội dung blog hỗ trợ seo website")}
...
`,
  ...
  },
  {
    ...
    imageUrl: "https://www.butphamarketing.com/slideshow.jpg",
    content: wrapArticle({
      metaTitle: "Thiết Kế Website Bán Hàng Chuyên Nghiệp",
      html: `
${toc([
...
${img(2, "thiết kế website bán hàng tăng chuyển đổi")}
...
${img(0, "giao diện cửa hàng online chuyên nghiệp")}
...
${img(1, "quy trình thanh toán website bán hàng")}
${internalLinks()}
${externalLinks()}
${faq([
...
`,
  ...
  },
  {
    ...
    imageUrl: "https://www.butphamarketing.com/slideshow1.jpg",
    content: wrapArticle({
      metaTitle: "Thiết Kế Website Theo Yêu Cầu Đáp Ứng Mọi Nhu Cầu",
      html: `
${toc([
...
${img(3, "thiết kế website theo yêu cầu riêng biệt")}
...
${img(0, "website tùy chỉnh theo ngành nghề")}
...
${img(2, "quy trình thiết kế website theo yêu cầu")}
${internalLinks()}
${externalLinks()}
${faq([
...
${img(0, "báo giá thiết kế website minh bạch")}
...
${img(1, "các hạng mục trong báo giá website")}
...
${img(2, "tối ưu chi phí thiết kế website")}
${internalLinks()}
${externalLinks()}
${faq([
...
${img(1, "thiết kế website công ty chuyên nghiệp")}
...
${img(0, "trang giới thiệu công ty trên website")}
...
${img(3, "nhận diện thương hiệu trên website công ty")}
${internalLinks()}
${externalLinks()}
${faq([
...
${img(2, "thiết kế website wordpress dễ quản trị")}
...
${img(0, "giao diện quản trị wordpress")}
...
${img(1, "tối ưu tốc độ website wordpress")}
${internalLinks()}
${externalLinks()}
${faq([
...
`,
  ...
  },
  {
    ...
    imageUrl: "https://www.butphamarketing.com/GoogleMaps.png",
    content: wrapArticle({
      metaTitle: "Thiết Kế Website Responsive Tối Ưu Trải Nghiệm",
      html: `
${toc([
...
${img(4, "thiết kế website responsive đa thiết bị")}
...
${img(0, "giao diện mobile website responsive")}
...
${img(1, "kiểm tra website responsive trên mobile")}
${internalLinks()}
${externalLinks()}
${faq([
...
${img(2, "cửa hàng thương mại điện tử online")}
...
${img(1, "marketing cho website tmđt")}
${internalLinks()}
${externalLinks()}
${faq([
...
${img(3, "dịch vụ thiết kế website trọn gói")}
...
${img(0, "gói dịch vụ website all-in-one")}
...
${img(1, "chọn đối tác thiết kế website trọn gói")}
${internalLinks()}
${externalLinks()}
${faq([
