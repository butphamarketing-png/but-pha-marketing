...
import { THAM_MY_ARTICLE_THUMBNAILS, thamMyThumbnailPath } from "./seo-article-helpers.mjs";
...
for (const [slug, entry] of Object.entries(THAM_MY_ARTICLE_THUMBNAILS)) {
  const imagePath = thamMyThumbnailPath(slug);
...
console.log("Done — tham-my thumbnails.");
