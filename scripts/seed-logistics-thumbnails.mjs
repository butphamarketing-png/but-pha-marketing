...
import { LOGISTICS_ARTICLE_THUMBNAILS, logisticsThumbnailPath } from "./seo-article-helpers.mjs";
...
for (const [slug, entry] of Object.entries(LOGISTICS_ARTICLE_THUMBNAILS)) {
  const imagePath = logisticsThumbnailPath(slug);
...
console.log("Done — logistics thumbnails.");
