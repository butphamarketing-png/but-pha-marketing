...
import { PCCC_ARTICLE_THUMBNAILS, pcccThumbnailPath } from "./seo-article-helpers.mjs";
...
for (const [slug, entry] of Object.entries(PCCC_ARTICLE_THUMBNAILS)) {
  const imagePath = pcccThumbnailPath(slug);
...
console.log("Done — pccc thumbnails.");
