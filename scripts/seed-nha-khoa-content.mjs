...
const REWRITES = [REWRITE_THIET_KE_WEBSITE_NHA_KHOA, REWRITE_THIET_KE_WEBSITE_NHA_KHOA_NIENG_RANG];
...
async function upsertArticle(article) {
  ...
  const count = (article.content.match(/\/tin-tuc\/nha-khoa\//g) || []).length;
  console.log(
    `Updated: ${article.slug} (${count} nha-khoa images in content)`,
...
console.log("Done — nha-khoa content seeded.");
