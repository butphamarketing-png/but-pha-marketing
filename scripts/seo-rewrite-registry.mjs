/**
 * Registry bài rewrite chất lượng cao — slug → article object.
 */
...
import { REWRITE_CHI_PHI_QUANG_CAO_GOOGLE_MAPS } from "./seo-rewrite-chi-phi-quang-cao-google-maps.mjs";
...
import { REWRITE_BAO_GIA_THIET_KE_FANPAGE } from "./seo-rewrite-bao-gia-thiet-ke-fanpage.mjs";
...
export const REWRITE_ARTICLES = [
  ...
  REWRITE_CHI_PHI_QUANG_CAO_GOOGLE_MAPS,
  ...
  REWRITE_BAO_GIA_THIET_KE_FANPAGE,
];
