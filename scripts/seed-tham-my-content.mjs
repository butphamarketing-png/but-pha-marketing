...
const REWRITES = [REWRITE_THIET_KE_WEBSITE_SPA, REWRITE_THIET_KE_WEBSITE_THAM_MY_VIEN];
...
async function upsertArticle(article) {
  ...
  const count = (article.content.match(/\/tin-tuc\/tham-my\//g) || []).length;
  console.log(
    `Updated: ${article.slug} (${count} tham-my images in content)`,
...
console.log("Done — tham-my content seeded.");
