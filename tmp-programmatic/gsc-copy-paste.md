...
2. Chọn property `https://www.butphamarketing.com`
3. Thanh trên → dán URL → Enter
4. **Request indexing** (nếu có nút)
5. Tick checkbox bên dưới khi xong

## Batch 1 — Core (7 URL) · làm trước

- [ ] `/website` — Money
  https://www.butphamarketing.com/website
- [ ] `/blog/thiet-ke-website` — Pillar
