...
### Thứ 2 — GSC indexing — batch core (7 URL)
- Channel: **GSC**
...
- Copy-paste:
```
Doanh nghiệp đang tìm đơn vị thiết kế website chuẩn SEO? Bứt Phá Marketing triển khai website 3–12 triệu, có case study GSC thật (Nha Khoa Đăng Khoa: 15,4K impressions). Xem dịch vụ: https://www.butphamarketing.com/website
```
- Sau khi gửi, log:
```bash
npm run build:backlink-weekly-tracker -- --log="Social LinkedIn/Facebook → /website — head term thiết kế website"
```

### Thứ 3 — Case study share — Nha khoa
- Channel: **Social**
- Target: `/du-an/nha-khoa-dang-khoa`
- Copy-paste:
```
Proof thực chiến: sau triển khai thiết kế website + SEO, Nha Khoa Đăng Khoa đạt 15,4K impressions và 471 clicks từ Google Search. Chi tiết: https://www.butphamarketing.com/du-an/nha-khoa-dang-khoa · Dịch vụ: https://www.butphamarketing.com/website
```
- Sau khi gửi, log:
```bash
npm run build:backlink-weekly-tracker -- --log="Social case study share → /du-an/nha-khoa-dang-khoa"
```

### Thứ 4 — Guest post pitch — pillar
- Channel: **Guest post**
...
Mình muốn đóng góp bài bổ sung cho độc giả của [Tên site] về chủ đề thiết kế website cho SME Việt Nam. Bài sẽ liên kết về hướng dẫn pillar (quy trình 7 bước + checklist): https://www.butphamarketing.com/blog/thiet-ke-website
...
- Sau khi gửi, log:
```bash
npm run build:backlink-weekly-tracker -- --log="Guest post pitch → /blog/thiet-ke-website — pillar thiết kế website"
```

### Thứ 5 — Vertical outreach — Logistics
- Channel: **Vertical**
...
- Sau khi gửi, log:
```bash
npm run build:backlink-weekly-tracker -- --log="Vertical ngành logistics → /website/nganh/logistics"
```

### Thứ 5 — Vertical outreach — Mỹ phẩm
- Channel: **Vertical**
...
- Sau khi gửi, log:
```bash
npm run build:backlink-weekly-tracker -- --log="Vertical ngành mỹ phẩm → /website/nganh/my-pham"
```

### Thứ 6 — Directory citation — NAP đồng bộ
- Channel: **Directory**
- Target: `/website`
- Copy-paste:
```
Bứt Phá Marketing — dịch vụ thiết kế website, SEO và Facebook Marketing cho SME Việt Nam.

Website: https://www.butphamarketing.com/website
Email: butphamarketing@gmail.com
Hotline: 0937417982
Địa chỉ: Tổ 8 ấp 6 Bình Mỹ Hồ Chí Minh
Liên hệ: https://www.butphamarketing.com/lien-he
```
- Sau khi gửi, log:
```bash
npm run build:backlink-weekly-tracker -- --log="Directory citation NAP → /website"
```

### Thứ 6 — Zalo inbox — báo giá
- Channel: **Zalo**
- Target: `/blog/bao-gia-thiet-ke-website`
- Copy-paste:
```
Chào anh/chị! Bảng giá thiết kế website Bứt Phá: 3 / 6 / 9 / 12 triệu tùy gói. Chi tiết yếu tố ảnh hưởng giá: https://www.butphamarketing.com/blog/bao-gia-thiet-ke-website · Đặt lịch tư vấn: https://www.butphamarketing.com/lien-he · Zalo: https://zalo.me/0937417982
```
- Sau khi gửi, log:
```bash
...
| Kênh | Loại | Ghi chú |
|---|---|---|
| LinkedIn cá nhân + Fanpage | Social | Head term + case study |
| Zalo OA / nhóm agency | Social / Vertical | Logistics + mỹ phẩm snippet |
| Blog marketing VN (guest post) | Guest | Pitch pillar link |
| Hotfrog / Cylex / Yelp VN | Directory | NAP block ở trên |
