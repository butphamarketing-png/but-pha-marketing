...
export const SERVICE_LANDING_PAGES: Record<string, ServiceLandingConfig> = {
  "website/thietkewebsite": {
    ...
    cta: {
      ...
      relatedLabel: "Xem gói Hosting website",
    },
  },

  "website/van-hanh-website": {
    slug: "website/van-hanh-website",
    platformName: "Hosting Website",
    platformKey: "website",
    color: PLATFORM_COLORS.website,
    seo: {
      title: "Hosting website chuyên nghiệp — bảo mật & bảo trì | Bứt Phá Marketing",
      description: "Gói Hosting website: hosting, backup, bảo mật, hỗ trợ kỹ thuật. Xem bảng giá tại /banggia.",
      keywords: ["hosting website", "thuê hosting", "bảo trì website"],
    },
    hero: {
      eyebrow: "Managed Hosting",
      title: "Hosting website chuyên nghiệp",
    ...
    sections: [
      ...
      },
      {
        ...
        title: "Quy trình triển khai",
        columns: 5,
        steps: ["Tiếp nhận website", "Kiểm tra hệ thống", "Tư vấn gói", "Thiết lập Hosting", "Theo dõi liên tục"],
      },
    ],
    cta: {
      title: "Website cần Hosting ổn định — không chỉ xây dựng",
