...
export const WEBSITE_INDUSTRY_CATALOG: WebsiteIndustryCatalogItem[] = [
  ...
  item({
    ...
    blogMoneySlug: "thiet-ke-website-cong-ty-xay-dung",
    hubSlug: "xay-dung",
  ...
  item({
    ...
    blogMoneySlug: "thiet-ke-website-my-pham",
    hubSlug: "my-pham",
    hasCaseStudy: false,
    hasLocalEntity: true,
    duplicateRisk: "low",
  ...
  item({
    ...
    blogMoneySlug: "thiet-ke-website-van-tai",
    hubSlug: "logistics",
    hasCaseStudy: false,
    hasLocalEntity: false,
  ...
  item({
    ...
    blogMoneySlug: "thiet-ke-website",
    hasCaseStudy: false,
    hasLocalEntity: false,
    duplicateRisk: "low",
    features: [
