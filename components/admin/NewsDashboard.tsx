                ...
                <div key={item.id} className="rounded-3xl border border-white/10 bg-white/5 p-4">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-2 rounded-2xl border border-indigo-400/20 bg-indigo-500/10 px-3 py-2 text-xs font-semibold text-indigo-100 transition hover:bg-indigo-500/15"
                    >
                      <Sparkles size={14} />
                      SEO Studio
                    </Link>
                    {item.slug ? (
                      <Link
                        href={`/blog/${item.slug}`}
                        target="_blank"
                        className="inline-flex items-center gap-2 rounded-2xl border border-cyan-400/20 bg-cyan-500/10 px-3 py-2 text-xs font-semibold text-cyan-100 transition hover:bg-cyan-500/15"
                      >
                        <Eye size={14} />
                        Xem
                      </Link>
