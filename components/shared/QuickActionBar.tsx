    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          {/* Call */}
          <a href={`tel:${hotline.replace(/\s/g, "")}`} className="flex flex-col items-center gap-1 text-white">
          ...
          {/* Zalo */}
          <a href={zaloUrl} target="_blank" rel="noreferrer" className="flex flex-col items-center gap-1 text-white">
          ...
          {/* Facebook */}
          <a href={messengerUrl} target="_blank" rel="noreferrer" className="flex flex-col items-center gap-1 text-white">
