    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-0 left-0 right-0 z-[60] flex items-center justify-around border-t border-violet-400/20 bg-[#12101c]/95 p-3 shadow-[0_-8px_30px_rgba(8,9,12,0.45)] backdrop-blur-lg md:hidden"
        >
          {/* Home */}
          <Link href="/" className="flex flex-col items-center gap-1 text-violet-100/80">
            <div className="flex h-11 w-11 items-center justify-center rounded-full border border-violet-400/25 bg-violet-500/15">
              <Home size={20} />
            </div>
          ...
          {/* Call */}
          <a href={getTelHref(settings.hotline)} className="flex flex-col items-center gap-1 text-violet-100/80">
          ...
          {/* Zalo */}
          <a href={zaloUrl} target="_blank" rel="noreferrer" className="flex flex-col items-center gap-1 text-violet-100/80">
          ...
          {/* Facebook */}
          <a href={messengerUrl} target="_blank" rel="noreferrer" className="flex flex-col items-center gap-1 text-violet-100/80">
          ...
          <button
            ...
            className="flex flex-col items-center gap-1 text-violet-100/50"
          >
