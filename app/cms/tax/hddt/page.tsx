...
import { EInvoicePanel } from "@/components/cms/EInvoicePanel";

export const metadata = {
  title: "Hóa đơn điện tử | CMS",
  robots: { index: false, follow: false },
};

export default function CmsTaxHddtPage() {
  return (
    <div className="min-h-screen bg-[#0b0f19]">
      <div className="border-b border-white/10 bg-[#111827]">
        <div className="mx-auto flex max-w-[1200px] flex-wrap items-center gap-3 px-4 py-2.5 sm:px-6">
          ...
          <span className="text-xs font-bold text-white">Hóa đơn điện tử (HĐĐT)</span>
        </div>
      </div>
      <EInvoicePanel />
    </div>
