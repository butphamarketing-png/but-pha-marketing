...
import { CitProvisionalPanel } from "@/components/cms/CitProvisionalPanel";

export const metadata = {
  title: "TNDN tạm nộp | CMS",
  robots: { index: false, follow: false },
};

export default function CmsTaxTndnPage() {
  return (
    <div className="min-h-screen bg-[#0b0f19]">
      <div className="border-b border-white/10 bg-[#111827]">
        <div className="mx-auto flex max-w-[1200px] flex-wrap items-center gap-3 px-4 py-2.5 sm:px-6">
          ...
          <span className="text-xs font-bold text-white">TNDN tạm nộp quý</span>
        </div>
      </div>
      <CitProvisionalPanel />
    </div>
